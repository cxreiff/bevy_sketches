...
fn vertex(vertex: Vertex) -> VertexOutput {
    ...
    out.world_position = mesh_position_local_to_world(mesh.model, vec4<f32>(vertex.position.x, noise * 0.2, vertex.position.z, 1.0));
    out.world_position.y = out.world_position.y - 4.0 * sin(t - out.world_position.z) / 20.0;
    out.world_position.z = out.world_position.z - 4.0 * sin(t - out.world_position.z) / 20.0;
